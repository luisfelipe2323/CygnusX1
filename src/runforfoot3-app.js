...
// import {menuIcon} from './utils/runforfoot3-icons.js';

class Runforfoot3 extends connect(store)(LitElement) {
...
window.customElements.define('runforfoot3-app', Runforfoot3);
